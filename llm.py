...
Supports OpenAI, Anthropic, and OpenRouter; add another provider by adding a branch here.
"""
import json
import os
...
def score_fit(resume: str, jd: str, provider: str = "openrouter", model: str = "openai/gpt-4o-mini") -> dict:
    ...
    if provider == "openai":
        ...
        # OpenRouter speaks the OpenAI chat-completions API, just on a different
        # base URL and with a different key format (sk-or-v1-...).
        from openai import OpenAI
